...
AudioPlayerMe::AudioPlayerMe(SampleFormat *sampleFormat, SLEngineItf engine) {

}

void AudioPlayerMe::SetBufQueue(AudioQueue *playQ, AudioQueue *freeQ) {

}

AudioPlayerMe::Engine

//void bqPlayerCallback(SLAndroidSimpleBufferQueueItf bq, void *ctx) {
//   (static_cast<AudioPlayerMe *>(ctx))->ProcessSLCallback(bq);
//}
//void AudioPlayerMe::ProcessSLCallback(SLAndroidSimpleBufferQueueItf bq) {
//#ifdef ENABLE_LOG
//   logFile_->logTime();
//#endif
...
//}
//
//AudioPlayerMe::AudioPlayerMe(SampleFormat *sampleFormat, SLEngineItf slEngine)
//        : freeQueue_(nullptr),
//          playQueue_(nullptr),
...
//}
//
//SLresult AudioPlayerMe::Start(void) {
//   SLuint32 state;
...
//}
//
//void AudioPlayerMe::RegisterCallback(ENGINE_CALLBACK cb, void *ctx) {
//   callback_ = cb;
//   ctx_ = ctx;
//}
//
//uint32_t AudioPlayerMe::dbgGetDevBufCount(void) {
